...
axs[0, 0].plot(range(len(alg_models)), recall_metric_val)
axs[0, 0].set_title('Recall for validation')
axs[0, 1].plot(range(len(alg_models)), precision_metric_val)
axs[0, 1].set_title('Precision for validation')
axs[1, 0].plot(range(len(alg_models)), recall_metric_test)
axs[1, 0].set_title('Recall for test')
axs[1, 1].plot(range(len(alg_models)), precision_metric_test)
